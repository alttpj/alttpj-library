...
public class Alttp3bppImageReader extends ImageReader {
   ...
   * {@inheritDoc}
   *
   * <p>The input is casted to an {@link ImageInputStream} for the Alttp3bppImageReader.</p>
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * <p>At the moment, we read the sprite map as a whole. Therefore, the image count is always one.<br>
   * However, in future versions this may change to represent the tiles.</p>
   *
   * @throws IllegalStateException if the inputstream is null or seek forward and allow search are both set.
   */
  @Override
